...
void CInstallMenus::InitMainMenu(CTextList::TListItemExecute MenuHandler, void *HandlerClass)
{
	...
	TextUI.AddMenuItem(0,"Install XOSL","Install Extended Operating System Loader 1.1.6",1);
	TextUI.AddMenuItem(2,"Uninstall XOSL","Uninstall Extended Operating System Loader 1.1.6",1);
	TextUI.AddMenuItem(4,"Restore XOSL","Make your system start XOSL again (typically after installing an OS)",1);

	TextUI.AddMenuItem(6,"Exit install","Quit without installing Extended Operating System Loader 1.1.6",1);
...
void CInstallMenus::InitInstallMenu(CTextList::TListItemExecute MenuHandler, void *HandlerClass)
{
	...
	TextUI.AddMenuItem(0,"Install on a DOS drive","Install XOSL 1.1.6 on a DOS drive (FAT16/FAT32)",FatAvail);
	TextUI.AddMenuItem(2,"Install on a dedicated partition","Install XOSL 1.1.6 on an existing dedicated partition",1);
...
void CInstallMenus::InitFixMbrMenu(CTextList::TListItemExecute MenuHandler, void *HandlerClass)
{
	...
	TextUI.AddMenuItem(0,"Restore on a DOS drive","Restore XOSL 1.1.6, installed on a DOS drive",FatAvail);
	TextUI.AddMenuItem(2,"Restore on a dedicated partition","Restore XOSL 1.1.6, installed on a dedicated partition",1);
	TextUI.AddMenuItem(6,"Return to main menu","Return to main menu",1);
	TextUI.SetItemIndex(FatAvail ? 0 : 2);
	TextUI.RefreshMenu();
}
...
void CInstallMenus::InitUninstallMenu(CTextList::TListItemExecute MenuHandler, void *HandlerClass)
{
	...
	TextUI.AddMenuItem(0,"Uninstall off a DOS drive","Uninstall XOSL 1.1.6 off a DOS drive",FatAvail);
	TextUI.AddMenuItem(2,"Uninstall off a dedicated partition","Uninstall XOSL 1.1.6 off a dedicated partition",1);
	TextUI.AddMenuItem(6,"Return to main menu","Return to main menu",1);
	TextUI.SetItemIndex(FatAvail ? 0 : 2);
	TextUI.RefreshMenu();
}
...
void CInstallMenus::InitInstFatMenu(CTextList::TListItemExecute MenuHandler, void *HandlerClass)
{
	...
	TextUI.AddMenuItem(3,"Ranish Partition Manager","Install Ranish Partition Manager 2.38 beta 1.9 together with XOSL 1.1.6",1,2,YesNoList,1);
	TextUI.AddMenuItem(4,"Smart Boot Manager","Install Smart Boot Manager 3.6.4 for CD-ROM booting support.",1,2,YesNoList,1);

	TextUI.AddMenuItem(6,"Start installation","Install Extended Operating System Loader 1.1.6",1);
...
void CInstallMenus::InitInstSepMenu(CTextList::TListItemExecute MenuHandler, void *HandlerClass)
{
	...
	TextUI.AddMenuItem(0,"Video mode","Initial video mode",1,ModeCount,ModeNameList,1);
	TextUI.AddMenuItem(1,"Mouse type","Initial mouse type",1,MouseTypeCount,MouseTypeNames,1);
	TextUI.AddMenuItem(2,"Ranish Partition Manager","Install Ranish Partition Manager 2.38 beta 1.9 together with XOSL 1.1.6",1,2,YesNoList,1);
	TextUI.AddMenuItem(3,"Smart Boot Manager","Install Smart Boot Manager 3.6.4 for CD-ROM booting support.",1,2,YesNoList,1);
	TextUI.AddMenuItem(4,"Drv Type System              Size ","Partition to install XOSL 1.1.6 on",1,PartNameCount,(const char **)PartNameList,0);
	TextUI.AddMenuItem(10,"Start installation","Install Extended Operating System Loader 1.1.6",1);
...
void CInstallMenus::InitErrorMenu(CTextList::TListItemExecute MenuHandler, void *HandlerClass)
{
	...
	TextUI.AddMenuItem(2,"Exit install","Quit without installing Extended Operating System Loader 1.1.6",1);
...
void CInstallMenus::InitFixMbrFat(CTextList::TListItemExecute MenuHandler, void *HandlerClass)
{
	...
	TextUI.AddMenuItem(4,"Start restore","Restore XOSL 1.1.6",1);
...
void CInstallMenus::InitFixMbrSep(CTextList::TListItemExecute MenuHandler, void *HandlerClass)
{
	...
	TextUI.AddMenuItem(6,"Start restore","Restore XOSL 1.1.6",1);
